...
Seleção de perfis animada: cada perfil tem uma imagem única e, ao passar o mouse, uma sombra é gerada dinamicamente a partir da cor dominante nas bordas da imagem – um exemplo de IA aplicada ao front-end.

Persistência com localStorage: o perfil escolhido (nome e imagem) é salvo localmente e exibido na página de catálogo, personalizando a navegação.

Catálogo dinâmico: interface similar à Netflix, com sliders de filmes e séries (conteúdo estático ou integrado via JavaScript).

Design responsivo: construído com HTML5, CSS3 e JavaScript puro.
...
JavaScript (manipulação do DOM, localStorage, análise de cores via Canvas)
